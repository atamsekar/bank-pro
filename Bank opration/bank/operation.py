...
:"""),
    ...
    def checkbalance(self):
        ...
        self.working()
        print ("Your account balance as at", date, " is" , self.balance)#.format(date, self.balance)
        self.transact_again()
    ...
    def passcheck(self):
        ...
        b=3
        while b>0:
            ans=input(r"Please type in your password to continue with the transaction\n: ")
